...
public abstract class MediaController extends LibraryController {
  ...
  private void handleDeletedCopies(ActionResult result) {
  ...
  private void handleNewMediaCopiesForExistingId(ActionResult result) {
