...
<%@ page import="com.objectmentor.library.application.models.MediaCopy" %>
  ...
  <table class="list">
    ...
    <tr class="<%= evenOdd[count++ % 2] %>">
      <td width="100%">
        ...
        <%= copy.getId() %>:&nbsp;<input type="checkbox" id='<%= "delete_"+isbn+"_"+copy.getId() %>'
                                         name='<%= "delete_"+copy.getId() %>'/>&nbsp;
        <% } %>
      </td>
      <td align="center">
