...
public class PatronsController extends Controller {
  ...
  public ActionResult manage() {
    ...
    Collection<Patron> patrons = patronGateway.findAllPatrons();
  ...
  public ActionResult history() {
    ...
    Collection<Patron> patrons = getPatrons();
    Iterator<Patron> iter = patrons.iterator();
    // Save the list of patrons to delete; we can't delete while iterating!
    ArrayList<Patron> patronsToDelete = new ArrayList<Patron>();
    while (iter.hasNext()) {
    	Patron patron = iter.next();
    ...
    Iterator<Patron> diter = patronsToDelete.iterator();
    while (diter.hasNext()) {
    	Patron patron = diter.next();
	...
	private Collection<Patron> getPatrons() {
		PatronGateway pg = getLibrary().getPatronGateway();
    Collection<Patron> patrons = pg.findAllPatrons();
		return patrons;
	}
