...
public class Application {
  ...
  private MockIsbnService initIsbnService() {
    ...
    mockIsbnService.setBookToReturn(new Media("1", "Book 1", "Author 5"));
    mockIsbnService.setBookToReturn(new Media("2", "Book 2", "Author 5"));
    mockIsbnService.setBookToReturn(new Media("3", "Book 3", "Author 5"));
    mockIsbnService.setBookToReturn(new Media("4", "Book 4", "Author 5"));
    mockIsbnService.setBookToReturn(new Media("5", "Book 5", "Author 5"));
