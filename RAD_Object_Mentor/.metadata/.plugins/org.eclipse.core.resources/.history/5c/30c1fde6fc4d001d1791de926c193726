...
public interface DataServices {
   ...
   * @return
   */
  int countActivePatrons();//TODO - this should return null instead of throw exception
  ...
  /**
   * Returns a BookTitle object using the submitted
   * String as an ISBN to match against it
   *
   * @param string
   * @return
   */
