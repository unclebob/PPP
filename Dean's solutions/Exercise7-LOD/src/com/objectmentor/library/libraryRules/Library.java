...
public class Library {
  protected CompactDiscCatalog compactDiscCatalog;
  private final ComputerCatalog computerCatalog;
	private final BookCatalog bookCatalog;

  public Library(BookCatalog bookCatalog,
    CompactDiscCatalog compactDiscCatalog, ComputerCatalog computerCatalog) {
    this.bookCatalog = bookCatalog;
		this.computerCatalog = computerCatalog;
    this.compactDiscCatalog = compactDiscCatalog;
  }
  ...
  public MediaCopy acceptCD(String cddbId) {
    return compactDiscCatalog.addCDCopy(cddbId);
  }

  public List acceptCDs(String barCode, int numberOfNewCDs) {
    return compactDiscCatalog.addCDCopies(barCode, numberOfNewCDs);
  }
