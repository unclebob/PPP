...
public class ActionResult {
  ...
  public ActionResult() {}
	...
	public void appendToInfoMessage(String message)    { infoMessage.append(message).append("<br/>"); }
	public void appendToWarningMessage(String message) { warningMessage.append(message).append("<br/>"); }
	public void appendToErrorMessage(String message)   { errorMessage.append(message).append("<br/>"); }
