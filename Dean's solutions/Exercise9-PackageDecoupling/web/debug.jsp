...
<tr>
  ...
  <table border="1" bgcolor="linen">
    ...
    <tr>
      ...
      <td><%=
      com.objectmentor.library.web.framework.ServletHelper.arrayToString(request.getParameterValues(name))  %>
      </td>
    </tr>
    <% } %>
  </table>
  ...
  <tr>
    <td>ISBN Service</td>
    <td><%=
    ((com.objectmentor.library.application.Application) request.getSession().getAttribute("Application")).getIsbnService() %>
    </td>
  </tr>
</table>
<% } %>
